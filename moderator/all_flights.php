...
if (isset($_POST['del_flight']) && isset($_SESSION['modId'])) {
  ...
  if ($stmt) {
    ...
    echo '<div class="alert alert-danger" style="text-align:center">Error preparing deletion query. Please try again.</div>';
    error_log("MySQLi prepare error: " . mysqli_error($conn));
  }
}
