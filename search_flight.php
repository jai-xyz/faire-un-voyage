...
<link rel="stylesheet" type="text/css"
	...
	<div class="conatiner-fluid p-4" style="background-color: #425560;">
			...
			<div id="horizontalTab">
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post" style="background:rgba(3, 3, 3, 0.57); padding: 25px 5px 50px 25px; ">
							...
							<div class="date">
								<div class="depart">
									...
									<input class="form-control" id="dep_date1" name="dep_date" type="date"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								...
								<div class="return">
									...
									<input class="form-control" id="ret_date" name="ret_date" type="date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
									<div class="invalid-feedback">
					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="book_flight.php" method="post" style="background:rgba(3, 3, 3, 0.57); padding: 25px 5px 50px 25px; ">
							...
							<div class="date">
								<div class="depart">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Depart</h3>
									<input  class="form-control" id="dep_date2" name="dep_date" type="date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
										<div class="invalid-feedback">
										Invalid departure date
									</div>
									</div>
...
const depDate1Input = document.getElementById('dep_date1');
const retDateInput = document.getElementById('ret_date');

retDateInput.addEventListener('change', (event) => {
  const selectedDepDate = new Date(depDate1Input.value);
  const selectedReturnDate = new Date(event.target.value); if (selectedReturnDate <= selectedDepDate) {
...
depDate1Input.addEventListener('change', (event) => {
...
const depDate2Input = document.getElementById('dep_date2');
depDate2Input.addEventListener('change', (event) => {
