...
<div class="flex-container">
    <div class="login-form mt-5" style="height: 350px;">
        <h1 class="text-center text-dark mb-4">Reset Password</h1>
        ...
        <form method="POST" action="includes/reset-request.inc.php">            
            ...
            <div class="submit">
            <button name="reset-req-submit" type="submit" class="button btn-info ">
                Submit</button>                    
            </div>
        </form>                          
    </div>
...
if(isset($_GET['mail'])) {
    if($_GET['mail'] === 'success') {
        echo '<script>alert("Email has been succesfully sent.");</script>';        
    }
} 
?>
