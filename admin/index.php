...
.dashbord-red .detail-section{
    ...
    <main>
      ...
      <div class="card-body">
        ...
        <p class="text-dark">Today's Flights</p>
    ...
    <!-- <div class="card" id="issue">
      <div class="card-body">
        ...
        <p class="text-dark">Today's Flight Issues</p>
        <table class="table-sm table table-hover">
          <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class=" text-dark">Flights Departed Today</p>
        <table class="table-sm table table-hover">
          <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-dark">Flights Arrived Today</p>
        <table class="table-sm table table-hover">
          <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
          ...
          <tbody>
              ...
              <?php
                ...
                <td>'.$row['source'].'</td>
                <td>'.$row['airline'].'</td>                
                <td>   <button class="btn btn-secondary disabled" type="button"> <strong> Arrived </strong>              
         </td>
              </button>  
             </tr> ' ; }} ?>
          </tbody>
