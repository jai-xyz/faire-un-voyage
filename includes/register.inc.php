            ...
            if($username_check > 0) {
                ...
                if(!mysqli_stmt_prepare($stmt,$email_sql)) {
                    ...
                    if($email_check > 0) {
                        ...
                        $sql = 'INSERT INTO Users (username, email, password, firstname, middlename, lastname, suffix, gender, province, city_municipality, barangay, house_no, birthdate)
                         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
                        $stmt = mysqli_stmt_init($conn);
                        if(!mysqli_stmt_prepare($stmt,$sql)) {
                            ...
                            mysqli_stmt_bind_param($stmt,'sssssssssssss', $username ,$email_id, $pwd_hash, $first_name, $middle_name, $last_name, $suffix, $gender, $province, $city_municipality, $barangay, $house_no, $birthdate);            
                            mysqli_stmt_execute($stmt); 
