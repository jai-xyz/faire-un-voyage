...
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-dark">PAY INVOICE</h1>
            <div id="pay-invoice" class="card">
                <div class="card-body">
            <label for="fname">Accepted Cards</label>
            <div class="icon-container">
              <i class="fa fa-cc-visa fa-3x" style="color:navy;"></i>
              <i class="fa fa-cc-amex fa-3x" style="color:red;"></i>
              <i class="fa fa-cc-mastercard fa-3x" style="color:gold;"></i>
...
<footer class="mt-5">
			<div class="conatiner-fluid" style="background-color: #425560;">
			<br>
	<em><h5 class="text-light text-center p-0 brand">
				<img src="assets/images/airtic.png" 
					height="40px" width="40px" alt="">				
			Faire un Voyage</h5></em>
